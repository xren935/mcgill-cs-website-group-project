...
class ProspectiveFreshman extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
    render() { 
      ...
      <a class="nav-link active" id="" data-toggle="pill" href="ProspectiveFreshman" role="tab">Freshman</a>
      ...
      <a class="nav-link" id="" data-toggle="pill" href="ProspectiveGrad" role="tab">Graduate Admission</a>
        ...
        <div class="col-sm-9">
<p>real content ProspectiveFreshman</p>
        </div>
    </div> 
     }
     </Spring>);
...
export default ProspectiveFreshman;
